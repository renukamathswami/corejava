...
public class CalculatorServiceImplServiceLocator extends org.apache.axis.client.Service implements com.manju.service.CalculatorServiceImplService {
    ...
    private java.lang.String CalculatorServiceImpl_address = "http://localhost:8081/WebServiceProject/services/CalculatorServiceImpl";
    ...
    public com.manju.service.CalculatorServiceImpl getCalculatorServiceImpl() throws javax.xml.rpc.ServiceException {
    ...
    public com.manju.service.CalculatorServiceImpl getCalculatorServiceImpl(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.manju.service.CalculatorServiceImplSoapBindingStub _stub = new com.manju.service.CalculatorServiceImplSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.manju.service.CalculatorServiceImpl.class.isAssignableFrom(serviceEndpointInterface)) {
                com.manju.service.CalculatorServiceImplSoapBindingStub _stub = new com.manju.service.CalculatorServiceImplSoapBindingStub(new java.net.URL(CalculatorServiceImpl_address), this);
                _stub.setPortName(getCalculatorServiceImplWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.manju.com", "CalculatorServiceImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.manju.com", "CalculatorServiceImpl"));
        }
